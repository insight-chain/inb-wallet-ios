...
- (void)configCustomNaviBar {
    ...
    _doneButton.frame = CGRectMake(self.view.tz_width - 44 - 12, _backButton.frame.origin.y, 44, 44);
...
- (void)configBottomToolBar {
    ...
    _toolBar.backgroundColor = [UIColor colorWithRed:rgb green:rgb blue:rgb alpha:0.8];
...
- (void)viewDidLayoutSubviews {
    ...
    if (_doneButton.superview == _naviBar) {
         _doneButton.frame = CGRectMake(self.view.tz_width - 44 - 12, _backButton.frame.origin.y, 44, 44);
    }else{
