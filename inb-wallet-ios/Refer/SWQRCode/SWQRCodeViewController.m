...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = NSLocalizedString(@"scan", @"扫一扫"); //[SWQRCodeManager sw_navigationItemTitleWithType:self.codeConfig.scannerType];
    [self _setupUI];
