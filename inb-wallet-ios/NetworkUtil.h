...
static NSString *explorWebUrl_local = @"http://explorer.insightchain.io/";
...
static NSString *explorWebUrl_production_default = @"http://explorer.insightchain.io/";
...
static NSString *explorWebUrl_test_default = @"http://explorer.insightchain.io/";
